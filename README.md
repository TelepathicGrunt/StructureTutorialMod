# Structure Tutorial Mod (Quilt)
**How to register and generate jigsaw structures in 1.18.2+ Minecraft Quilt using nbt files! In fact, you can actually make structures using only json files in 1.18.2+ MC!**
