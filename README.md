...
**How to register and generate jigsaw structures in 1.20.4+ Minecraft Fabric using nbt files! In fact, you can actually make structures using only json files in 1.18.2+ MC!**
