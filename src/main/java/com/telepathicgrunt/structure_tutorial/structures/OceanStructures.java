...
public class OceanStructures extends Structure {
    ...
    public static final MapCodec<Structure.Config> CUSTOM_STRUCTURE_SETTINGS_CODEC = RecordCodecBuilder.mapCodec(
            codecBuilder -> codecBuilder.group(
                            ...
                            FilterHolderSet.codec(RegistryKeys.BIOME, Biome.REGISTRY_CODEC, false).fieldOf("biomes").forGetter(x -> x.biomes() instanceof FilterHolderSet<Biome> filterHolderSet ? filterHolderSet : new FilterHolderSet<>(x.biomes(), RegistryEntryList.of(List.of()))),
