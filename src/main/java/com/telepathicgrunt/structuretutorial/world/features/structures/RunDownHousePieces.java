...
/*
 * This class is based off of the IglooPieces class which I am assuming is doing the proper way of
 * generating structures. If you look at SwampHutPiece or DesertPyramidPiece, you'll see they manually
 * hardcoded every block by hand which is tedious and time consuming. It is also difficult to visualize it
 * which is why I highly encourage the use of structure blocks.
 * 
 * Also, you might notice that some structures like Pillager Outposts or Woodland Mansions uses a special 
 * block called Jigsaw Block to randomize which structure nbt to use to attach to other parts of the structure
 * and still keep it looking clean. This is somewhat complicated and I haven't looks into this yet. But once
 * you're familiar with modding and is pretty experienced with coding, go try and make a structure using 
 * Jigsaw blocks! (Look at PillagerOutpostPieces and how it used JigsawPattern and JigsawManager.
...
public class RunDownHousePieces
{
	 ...
	 * 
	 * Move the nbt file of your structure into asses.mod_id.structures folder under src/main/resources in your mod. 
	 * Make sure the nbt file name is all lowercase and uses no spaces.
	 * 
	 * Here, I have two structure nbt files named run_down_house_left_side.nbt and run_down_house_right_side.nbt
	 * and I access them with the following resource locations below. The MODID and ':' are important too.
	 */
	...
	/*
	 * Here's where some voodoo happens. Most of this doesn't need to be touched 
	 * but you do have to pass in the IStructurePieceType you registered into the
	 * super constructors.
	 * 
	...
	public static class Piece extends TemplateStructurePiece 
	{
		 ...
		 * In this case, our structure has a data maker with the string "chest" put into it. So we check to see if
		 * the incoming function is "chest" and if it is, we now have that exact position.
		 * 
